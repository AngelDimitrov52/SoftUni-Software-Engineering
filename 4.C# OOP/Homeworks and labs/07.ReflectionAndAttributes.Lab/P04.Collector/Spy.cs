...
namespace Stealer
{
    public class Spy
    {
        ...
        public string CollectGettersAndSetters(string className)
        {
            ...
            foreach (var mothod in methodInfos.Where(s => s.Name.StartsWith("get")))
            {
                sb.AppendLine($"{mothod.Name} will return {mothod.ReturnType}");
            }
            foreach (var method in methodInfos.Where(s => s.Name.StartsWith("set")))
            {
